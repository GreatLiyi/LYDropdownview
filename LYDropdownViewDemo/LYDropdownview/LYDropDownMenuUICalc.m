...
@interface LYDropDownMenuUICalc :NSObject
...
@end
@implementation LYDropDownMenuUICalc
+ (instancetype)sharedInstance
{
    static LYDropDownMenuUICalc *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[LYDropDownMenuUICalc alloc] init];
    });
...
{
    return [[LYDropDownMenuUICalc sharedInstance] menuUIValue];
}


ZLDROPDOWNMENU_TITLEBUTTON_UI_VALUE *dropDownMenuTitleButtonUIValue()
{
    return [[LYDropDownMenuUICalc sharedInstance] titleButtonUIValue];
}

ZLDROPDOWNMENU_COLLECTIONVIEW_UI_VALUE *dropDownMenuCollectionViewUIValue()
{
    return [[LYDropDownMenuUICalc sharedInstance] collectionViewUIValue];
}
